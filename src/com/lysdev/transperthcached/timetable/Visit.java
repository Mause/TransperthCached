...
public class Visit {
    public String stop_num; // num as string lol
    public String route_number;
    public LocalTime time;

    public Visit(String stop_num, String route_number, LocalTime time) {
        this.stop_num = stop_num;
        this.route_number = route_number;
        this.time = time;
    }

    public static Visit fromRaw(String stop_num, int route_number, int hours, int minutes) {
